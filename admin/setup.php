...
if($db !== false && db_table_exists($db, "pm_%") === true){
    $installed = true;
    $_SESSION['msg_notice'][] = "It seems that Hotels CMS is already installed. Remove your former tables from your database to reinstall it <a class=\"btn btn-default\" href=\"login.php\">Log in</a>";
}
